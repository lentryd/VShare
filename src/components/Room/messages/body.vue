<template>
  <div ref="room" class="room-messages" @scroll="detectScroll">
    <div class="hello">
      <svg
      ...
      >
        <g>
          <g xmlns="http://www.w3.org/2000/svg">
            <g>
              <path
                d="m419.637 501.741s36.639-17.191 41.074-48.53c4.435-31.338-20.356-48.432-20.356-48.432s50.168-16.059 45.06-85.606c-5.107-69.547-51.592-80.79-51.592-80.79s18.978-92.573-73.071-54.475c0 0 23.173-124.705-65.358-84.05l-23.893 223.052z"
                fill="#faf1a9"
              ></path>
              <path
                d="m438.572 404.497s54.088-15.583 49.675-88.405c-.794-13.096-10.881-31.779-14.053-41.271 3.746 103.962-72.253 140.032-138.59 74.099-3.56-3.538-19.985 31.097-24.715 29.688l103.959 126.749s39.586-17.092 44.827-49.744c5.24-32.653-21.103-51.116-21.103-51.116z"
                fill="#dfb5a7"
              ></path>
              <path
                d="m350.605 408.195c11.168-15.864 19.889-33.938 28.011-62.695l17.273-57.109c5.803-20.544 4.954-41.393-1.258-60.25 6.313-3.605 12.36-9.162 17.69-16.842 16.232-23.389 10.123-64.113 2.84-69.167s-47.57 3.472-63.802 26.86c-.641.924-1.239 1.847-1.816 2.768-7.623-4.551-15.959-8.192-24.91-10.72l-61.283-17.309c-4.577-1.293-9.071-2.186-13.477-2.738.964-5.808.932-12.312-.306-19.424-4.833-27.755-37.45-52.183-46.092-50.678-8.643 1.506-31.082 35.521-26.249 63.275 1.599 9.183 4.75 16.736 8.964 22.62-14.249 9.188-25.184 20.563-31.688 29.596-15.697 21.8-29.471 53.682-29.471 53.682-30.295 15.77-46.616 44.446-44.613 73.964 1.653 24.355 12.666 44.98 30.411 61.485 15.597 14.507 44.249 26.22 60.857 29.389l2.55 1.228c-.461 1.53-.911 3.086-1.356 4.654-61.224-22.927-111.266-43.03-120.559-15.028-9.343 28.152 40.12 45.102 101.794 68.182l15.984-42.713c-7.31 29.236-11.795 62.024-11.757 80.413h258.908c-15.125-40.73-38.99-72.573-66.645-93.443z"
                fill="#ffffff"
              ></path>
              <path
                d="m96.423 387.64c-13.274-6.247-34.813-2.47-39.045 7.255-4.231 9.724 7.523 30.102 20.975 35.955 13.453 5.853 24.748-40.068 18.07-43.21z"
                fill="#f6e06e"
              ></path>
              <path
                d="m311.213 187.608c.097-.45.175-.907.209-1.382 4.431-17.356 3.583-33.76-4.97-48.773 5.352-19.306 4.649-35.763-4.913-48.216.099-23.054-2.769-48.523-7.713-75.682-.416-4.085-6.204-4.507-7.209-.526-7.724 20.87-13.636 40.631-14.454 57.276-8.862 11.135-12.693 23.86-9.778 38.747-7.919 11.569-12.009 24.805-10.221 40.5-10.177 11.612-9.134 25.26-9.163 31.571 1.168 21.554 63.906 26.435 68.212 6.485z"
                fill="#ccf3e2"
              ></path>
              <path
                d="m311.213 187.608c.097-.45.175-.907.209-1.382 3.147-12.326 3.612-24.168.565-35.376-.35 3.315-.957 6.672-1.822 10.073-.027.406-.092.797-.174 1.181-3.635 17.033-58.762 12.398-59.945-6.046-.004-1.042-.045-2.32-.045-3.772-7.852 10.951-6.974 23.016-7.001 28.838 1.169 21.553 63.907 26.434 68.213 6.484z"
                fill="#b1b6e1"
              ></path>
              <path
                d="m156.712 162.236c16.058-3.891 29.959-13.55 39.924-26.729 2.83-3.743 6.27-7.147 10.306-10.065 19.28-13.937 46.277-11.559 62.806 5.551 19.714 20.407 17.656 52.842-3.746 70.667-18.427 15.347-41.407 17.251-60.322 11.031-11.019-3.624-34.658-18.008-52.473-29.384-8.624-5.507-6.439-18.662 3.505-21.071z"
                fill="#faf1a9"
              ></path>
              <path
                d="m269.748 130.993c-16.529-17.109-43.526-19.488-62.806-5.551-4.037 2.918-7.476 6.321-10.306 10.065-9.965 13.178-23.866 22.838-39.924 26.729-9.944 2.41-12.129 15.564-3.505 21.071 17.815 11.377 41.453 25.76 52.472 29.384 18.915 6.221 41.896 4.317 60.323-11.031 21.402-17.825 23.461-50.26 3.746-70.667zm-10.777 44.545c-10.882 13.415-27.04 17.815-41.509 15.866-8.429-1.135-27.503-8.299-41.959-14.082-6.997-2.8-7.408-12.498-.654-15.537 10.906-4.906 19.403-13.654 24.556-24.398 1.463-3.052 3.414-5.942 5.864-8.563 11.704-12.519 31.379-14.387 45.775-4.333 17.171 11.991 20.566 35.466 7.927 51.047z"
                fill="#dfb5a7"
              ></path>
              <path
                d="m251.534 292.238c5.862.483 9.321 9.943 6.823 18.751-6.118 21.573-19.359 36.354-33.417 35.195-14.057-1.158-24.7-17.908-27.204-40.191-1.022-9.098 3.938-17.864 9.8-17.381z"
                fill="#d789b9"
              ></path>
              <path
                d="m251.534 292.238-43.998-3.626c-5.862-.483-10.823 8.284-9.8 17.381 2.504 22.283 13.147 39.032 27.204 40.191 1.876.154 3.737.016 5.569-.375-6.751-2.542-12.646-8.748-13.881-19.741-.645-5.741 4.965-15.582 8.664-15.277l27.762 2.288c1.558.128 2.841 1.269 3.694 2.953.578-1.636 1.119-3.315 1.609-5.043 2.498-8.808-.96-18.268-6.823-18.751z"
                fill="#c668b9"
              ></path>
              <path
                d="m350.695 408.194c11.168-15.863 19.889-33.938 28.011-62.695l17.273-57.109c5.802-20.544 4.954-41.393-1.259-60.25 6.313-3.604 12.361-9.162 17.69-16.842 16.232-23.388 10.124-64.112 2.841-69.167-3.36-2.331-13.746-1.766-25.552 1.809 4.747 7.965 3.99 44.48-11.986 65.045-5.513 7.098-11.368 12.13-17.199 15.282 2.888 18.34.956 38.333-6.597 57.719l-21.969 53.837c-7.048 18.091-13.719 31.626-20.797 42.981-5.793 9.294-5.411 21.149 1.114 29.944 8.923 12.026 16.628 26.266 22.696 42.483 6.355 16.984-6.76 34.917-24.866 33.911l-150.37-3.349c-1.094 9.599-1.308 13.179-1.294 19.847h258.909c-15.125-40.732-38.99-72.575-66.645-93.446z"
                fill="#e1bdfc"
              ></path>
              <path
                d="m455.03 51.17 8.214 23.098c.352.989 1.048 1.772 1.927 2.168l20.521 9.246c2.899 1.306 2.899 5.925 0 7.232l-20.521 9.246c-.879.396-1.575 1.18-1.927 2.169l-8.214 23.097c-1.161 3.263-5.264 3.263-6.425 0l-8.214-23.097c-.352-.989-1.048-1.773-1.927-2.169l-20.521-9.246c-2.899-1.306-2.899-5.925 0-7.232l20.521-9.246c.879-.396 1.575-1.179 1.927-2.168l8.214-23.098c1.16-3.263 5.264-3.263 6.425 0z"
                fill="#ccf3e2"
              ></path>
              <circle
                cx="28.155"
            ...
            <g>
              ...
              <g fill="#000000">
                ...
                <ellipse
                  ...
                  rx="12.656"
                  ry="12.656"
                  transform="matrix(.261 -.965 .965 .261 -38.04 487.496)"
                  fill="#000000"
                  data-original="#000000"
                ></ellipse>
                <path
                  d="m29.049 379.214c-1.109 0-2.232-.3-3.243-.929-2.886-1.794-3.771-5.589-1.977-8.475 13.388-21.538 30.922-22.984 31.661-23.035 3.409-.229 6.329 2.326 6.563 5.716.232 3.367-2.289 6.288-5.644 6.558-.638.065-12.308 1.464-22.126 17.259-1.167 1.875-3.176 2.906-5.234 2.906z"
                  fill="#000000"
                  data-original="#000000"
                ></path>
              </g>
      ...
      <span class="title"> Привет, {{ name }}! </span>

      <span v-if="isMy" class="advice">
        <svg
          class="icon"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    <Day :key="i" v-for="(day, i) in days" v-bind="day" />
  </div>
</template>
...
const exampleMessages = [
  ...
  },
  {
    ...
    isPending: false,
    type: "message",
    text: "может надо ввести пароль?",
  },
] as Firebase["room"]["messages"];
